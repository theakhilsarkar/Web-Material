...
# 📘 50 MCQs – React, JavaScript, Firebase, Redux Toolkit, APIs, Axios
...
* a) A CSS file
* b) A database query
* c) A JavaScript function or class that returns UI ✅
* d) A JSON object
...
* b) `function App() { return <h1>Hello</h1>; }` ✅
...
* b) Simplifying Redux boilerplate ✅
...
Which OOP principle is “hiding internal details and showing only necessary info”?
...
* a) Routing in React
* b) Styling and responsive design ✅
* c) State management
...
* a) Styling components
* b) Passing props deeply without drilling ✅
* c) Handling routing
* d) Fetching APIs
...
* a) Store data that changes over time ✅
* b) Define CSS styles
* c) Define routes
...
* b) State value and setter function ✅
...
* a) signInWithPopup(GoogleProvider) ✅
